...
class MySolutions:
    ...
    def get_simple_logistic_reg(self):
        ...
        clf.fit(self.X_train_original, self.y_train_original)
        labels_train = clf.predict(self.X_train_original)
        probas_train = clf.predict_proba(self.X_train_original)
        labels_test = clf.predict(self.X_test_original)
        probas_test = clf.predict_proba(self.X_test_original)
